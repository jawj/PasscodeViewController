...
This is a passcode view controller that you're free to use in your own iPhone apps.

I developed it for use in the "mappiness":http://www.mappiness.org.uk/ app. You can see it in action by downloading (and signing up to) that app. Or you can check out this "short screencast":http://blog.mackerron.com/2011/07/passcode-view-controller/.
